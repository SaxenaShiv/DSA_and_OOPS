...
//	print instructions to player
	public void printInstructions() {
		System.out.println("Welcome to the MadLibs game.If you type in" +
								"words,we'll give u a story.Start by typing in a name");
	}
	...
	public void enterAdverb() {
		System.out.println("Now enter adverb!");
	...
	public void putTogetherTheStory() {
		...
		if(num==0) {
		story = "Jesse and her best friend "+getName()+"went to Diseny World today!"+
