...
public class FindNumberOfEMployeesUnderEveyManager {
	...
	public static void findEmp(HashMap<String,String>map) {
	...
	public static int getSize(HashMap<String,HashSet<String>>tree,String man,HashMap<String,Integer>result) {
		...
		int sz = 0;
		for(String en:tree.get(man)) {
			int cs = getSize(tree,en,result);
			sz +=cs;
		}
		result.put(man, sz);
		return sz+1;
